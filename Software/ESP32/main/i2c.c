...
)
{
    ...
    return i2c_driver_install(i2c_master_port, i2c_configuration.mode, I2C_MASTER_RX_BUF_DISABLE,
...
{
    return i2c_master_read_from_device(I2C_MASTER_NUM, device_addr, data, length,
                                       10 * I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
}
...
{
    return i2c_master_write_to_device(I2C_MASTER_NUM, device_addr, data, length,
