...
void paper_start(
    void); // Turn on the witness papervoid paper_stop(void);                                    // Turn off the paper drive if it is running
...
void DCmotor_on_off(bool on,
                    unsigned long duration);    // Turn the motor on or off
